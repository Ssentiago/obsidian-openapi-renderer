...
import DraftVersion from 'ui/views/OpenAPI Version/components/modes/normal/components/draft-version/DraftVersion';
import NoVersionsMessage from 'ui/views/OpenAPI Version/components/modes/normal/components/no-version-available/no-versions-available';
import VersionList from 'ui/views/OpenAPI Version/components/modes/normal/components/version-list/VersionList';
