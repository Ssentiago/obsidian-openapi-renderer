...
export class OpenAPISettingTab extends PluginSettingTab {
    ...
    /**
     * Displays various general settings and options in the container element.
     *
     * Also displays settings sections
     *
    ...
    display(): void {
        ...
        new Setting(containerEl)
            ...
            .setDesc(
                'Automatically download plugin assets from GitHub releases?'
            )
            .addToggle((toggle) => {
                toggle
