export enum eventID {
    ...
    OpenAPIThemeChangeState = 'openapi-renderer-openapi-theme-change',
    ...
    UpdateOpenAPIViewState = 'openapi-renderer-update-openAPIViewState',
    PreviewState = 'openapi-renderer-preview-state',
}
