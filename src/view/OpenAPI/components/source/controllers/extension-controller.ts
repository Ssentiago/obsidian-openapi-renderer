...
import createBoundKeymap from 'view/OpenAPI/components/source/extensions/keymap';
import { onChange } from 'view/OpenAPI/components/source/handlers/editor-handlers';
import {
    handleChangeFontSizeOnWHeel,
    handleScroll,
} from 'view/OpenAPI/components/source/handlers/wheel-scroll-handlers';
import {
    ExtensionsStorage,
    UserExtensions,
