...
import { convertData, createNewLeaf } from 'view/common/helpers';
...
import { RestoredLabel } from 'view/views/OpenAPI Version/components/modes/normal/components/draft-version/styled/draftVersionStyled';
import {
    ModalFormData,
    SaveCurrentVersionModal,
} from 'view/views/OpenAPI Version/components/modes/normal/modals/save-current-version-modal/save-current-version-modal';
