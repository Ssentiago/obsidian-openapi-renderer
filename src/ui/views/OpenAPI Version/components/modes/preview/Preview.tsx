...
import { SpecDetails } from 'ui/views/OpenAPI Version/components/modes/preview/styled/previewStyled';
import { Button } from 'ui/views/OpenAPI Version/components/modes/styled/common-styled';
